...
from geometry.continuous_remesh import calc_edge_length, calc_edges, calc_face_collapses, calc_face_normals, calc_vertex_normals, collapse_edges, flip_edges, pack, prepend_dummies, remove_dummies, split_edges
...
class MeshOptimizer:
    ...
    def __init__(self, 
            ...
            edge_len_lims=(5,75), #smallest and largest allowed reference edge length
            edge_len_tol=50, #edge length tolerance for split and collapse
